...
public class ExceptionWrappingFilter : IExceptionFilter
{
    ...
    public void OnException(ExceptionContext context)
    {
        ...
        foreach (var activityEvent in Activity.Current.Events)
        {
            this._logger.LogInformation("exist event: {Event}", activityEvent.ToString());
        }
        ...
        foreach (var activityEvent in Activity.Current.Events)
        {
            this._logger.LogInformation("appended event: {Event}", activityEvent.ToString());
        }

        this._logger.LogError("ExceptionHandled = false");
